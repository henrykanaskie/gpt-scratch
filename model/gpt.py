...
class GPT(nn.Module):
    ...
    def __init__(self, vocab_size: int, context_length: int, model_dim: int, num_blocks: int, num_heads: int):
        ...
        self.embed_position = nn.Embedding(context_length, model_dim)
    ...
    def forward(self, context: TensorType[int]) -> TensorType[float]:
        ...
        embedded = embedded + self.embed_position(positions)
        transformed = self.transformer_blocks(embedded)
        normed = self.final_norm(transformed)
        logits = self.vocab_projection(normed)
